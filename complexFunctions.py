...
def complex_max_pool2d(inputr,inputi,kernel_size, stride=None, padding=0,
    ...
    return (absolute_value * torch.cos(angle)).real, (absolute_value * 1j*torch.sin(angle)).imag
